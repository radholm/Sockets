...
public class ServerConnect {
    ...
    public void connect(String host, int port, ServerResponse serverMsg) throws IOException {
        socket = new Socket();
    ...
    private class Listener implements Runnable {
        private final ServerResponse outputHandler;
        
        private Listener(ServerResponse outputHandler) {
